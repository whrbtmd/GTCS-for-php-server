...
/*$sth = mysqli_query($connection,"SELECT pfood_name FROM order_complete");
$rows = array();
$rows['name'] = 'pfood_name';
while($r = mysqli_fetch_array($sth)) {
    $rows['data'][] = $r['pfood_name'];
}*/
$sth = mysqli_query($connection, "SELECT sell FROM sell_complete");
$rows1 = array();
$rows1['name'] = 'sell';
